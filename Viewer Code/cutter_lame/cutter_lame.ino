...
// A4 - A5 reserved
int delayLen=500;
const int posLat=360;
const int posBack=160;
const int posFront=450;
int pos=posLat;
int x=1;
int y=1;
int z=1;
...
const float offset1in = 4.4; // Back Sensor
...
int pivot_left(int value) {
  set_wheel_servos(-SERVO_MEDIUM, -SERVO_MEDIUM-20, -SERVO_MEDIUM-20, -SERVO_MEDIUM-20);
  delay(value);
  set_wheel_servos(0, 0, 0, 0);
  return 0;
}
